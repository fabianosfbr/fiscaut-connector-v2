    ...
    def log(
        ...
        try:
            ...
            if level.upper() not in valid_levels:
                ...
                logging.warning(
                    f"Nível de log inválido '{level}' fornecido para LoggingService. Usando ERROR como padrão."
                )
